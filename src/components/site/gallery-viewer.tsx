/**
 * GalleryViewer — Behance-style masonry gallery
 *
...
// ── CHANGE THIS to adjust the default aspect ratio of all gallery cards ───
    ...
    <section aria-label="Project gallery" className="pt-6">
      ...
      {/*
        Adjust column count here:
          columns-1               → 1 column on all screens
          sm:columns-2            → 2 columns on sm+
          lg:columns-2            → 2 columns on lg (remove lg:columns-3 below)
          lg:columns-3            → 3 columns on lg+ (default)
          xl:columns-4            → 4 columns on xl+ (add this for very wide screens)
      */}
    ...
    content = (
      <div className="relative w-full h-full flex items-center justify-center bg-black/5">
        ...
        <img
          ...
          /*
            IMAGE FITTING:
              object-contain → shows full image, no cropping (default for lightbox)
