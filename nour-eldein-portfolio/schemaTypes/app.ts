...
export default defineType({
  ...
  fields: [
    ...
    defineField({name: 'version', title: 'Version (e.g. 1.2.0)', type: 'string'}),
    defineField({name: 'releaseDate', title: 'Release Date (e.g. Sep 2023)', type: 'string'}),
    defineField({
      name: 'apkFile',
      title: 'APK/AAB File',
      type: 'file',
      description: 'Upload the app package. Size will be automatically detected.',
      options: { accept: '.apk,.aab,application/vnd.android.package-archive' },
    }),
